...
{{--                            </div>--}}
    ...
    <div class="col-lg-9 col-12 login-page-right">
        ...
        <div class="login-description">
            <div class="card col-lg-4 ml-auto">
                <h2>
                    <div class="card-header">公 告 栏</div>
                </h2>
                <div class="card-body">
                    <table class="table table-hover table-sm">
                        <thead>
                        <tr>
                            <th style="color:#303030">公告</th>
                            <th style="color:#303030">发布时间</th>
                        </tr>
                        </thead>
                        <tbody>
                        @foreach( notice() as $notice)
                            <tr>
                                <td><a href="#"
                                       onclick="notice_layer({{$notice->id}})">{{$notice->name}}
                                    </a></td>
                                <td style="color:#303030">{{$notice->created_at}}</td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
...
<script>
    ...
    function notice_layer(id) {
        layer.open({
            ...
            shade: 0.8,
            area: ['90%', '90%'],
            content: '/notice/' + id + '/view' //iframe的url
        });
    }
</script>
